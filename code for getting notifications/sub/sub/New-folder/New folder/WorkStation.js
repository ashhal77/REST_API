...
var SendSubscriptionRequest = require('./SendSubscriptionRequest')(BUFFER).sr;
var Pallet_data = require('./Pallet_data').pd;
...
{	
    ...
    app.listen(this.port, this.url , function (err) {
		...
		setInterval(function(){
					var ordersPerStation = Math.ceil(USER_ORDER.length / TOTAL_WORKSTATIONS); 
					if(ordersToProcess >= ref.job_queue){
						ref.isBusy = true;
					}
