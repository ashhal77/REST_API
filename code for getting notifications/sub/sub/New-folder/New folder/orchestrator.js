...
var WorkStation = require('./WorkStation').ws;
var startBuffer = require('./WorkStation').startBuffer;
var workStationOrder = require('./WorkStation').setOrder;
//(USER_ORDER);
...
function startOrchestrator(computerIP){
	...
	var WORK_STATION_IPS = require('./workStationIps').getUrls;
	...
	//var SimCNV8 = new WorkStation(5001,8, AGENTSURL, WORK_STATION_IPS['ws8']['cnv'], WORK_STATION_IPS['ws7']['rob']);
	//var SimCNV5 = new WorkStation(5010,5, AGENTSURL, WORK_STATION_IPS['ws5']['cnv'], WORK_STATION_IPS['ws7']['rob']);
